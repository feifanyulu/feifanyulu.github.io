...
![image-20250614160631092](Attention/image-20250614160631092.png)
...
![image-20250702131140598](Attention/image-20250702131140598.png)
...
![image-20250702130134638](Attention/image-20250702130134638.png)
...
![image-20250623145556122](Attention/image-20250623145556122.png)
...
![image-20250703130557853](Attention/image-20250703130557853.png)
...
![image-20250703131648751](Attention/image-20250703131648751.png)

例如，应用在MPT-7B这个大模型上的**Alibi**方法

![image-20250711154434905](Attention/image-20250711154434905.png)

(2) 乘法--旋转位置编码
![image-20250703131908105.png](Attention/image-20250703131908105.png)

例如，比较典型的方法**RoPE**，应用在LLaMa、LLaMa-2、GPT-J等等大模型上：

![image-20250711154831800](Attention/image-20250711154831800.png)
...
![image-20250702135332234](Attention/image-20250702135332234.png)
...
![image-20250702142631305](Attention/image-20250702142631305.png)
...
![image-20250702154800651](Attention/image-20250702154800651.png)
...
![image-20250613211354141](Attention/image-20250613211354141.png)
...
![image-20250703132301010](Attention/image-20250703132301010.png)

**掩码自注意力机制**

注意力得分矩阵A可以包含一个词和所有上下文之间的关系，需要把矩阵A如下图部分的词给屏蔽掉，把这些位置分别设置为无穷小，这样在softmax计算时一定为0了；

![image-20250703134022128](Attention/image-20250703134022128.png)
...
![image-20250701143345467](Attention/image-20250701143345467.png)

输出不再是$ F(x) $ ，而是 $ F(x)+x $；使用残差网络的原因是为了防止连乘导致梯度消失。

![image-20250701143602604](Attention/image-20250701143602604.png)
根据后向传播的链式法则
$$
...
![image-20250701155113203](Attention/image-20250701155113203.png)

Encoders的输出与每一个Encoder进行交互，Encoders生成的KV矩阵

![image-20250701155328375](Attention/image-20250701155328375.png)

# 基于transformer发展的大语言模型

![image-20250701163851564](Attention/image-20250701163851564.png)
