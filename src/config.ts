...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://feifanyulu.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-02-01", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// 		{
		// 			name: "GitHub",
		// 			url: "https://github.com/feifanyulu",
		// 			external: true,
		// 			icon: "fa7-brands:github",
		// 		},
		// 		{
		// 			name: "Bilibili",
		// 			url: "https://space.bilibili.com/674865028",
		// 			external: true,
		// 			icon: "fa7-brands:bilibili",
		// 		},
		// 		{
		// 			name: "Gitee",
		// 			url: "https://gitee.com/feifanyulu",
		// 			external: true,
		// 			icon: "mdi:git",
		// 		},
		// 	],
...
export const profileConfig: ProfileConfig = {
	...
	name: "Feifanyulu",
	bio: "Maximize happiness, minimize trouble.",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://feifanyulu-twikoo.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
